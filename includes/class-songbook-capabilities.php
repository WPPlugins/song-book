...
/**
 * SONGBOOK_Capabilities class.
 */
class SONGBOOK_Capabilities {
	...
	public function __construct( ) {
            ...
            add_filter( 'map_meta_cap', array( $this, 'song_book_map_meta_cap' ), 10, 4);


	}

	/**
	 * song_book_add_role_caps function.
	 *
	 * @access public
	 * @return void
	 */
        public static function song_book_add_role_caps() {
    ...
    public function song_book_map_meta_cap( $caps, $cap, $user_id, $args ) {
